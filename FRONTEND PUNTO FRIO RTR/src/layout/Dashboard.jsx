        ...
        <div className='md:flex md:min-h-screen'>
            ...
            <div className='md:w-1/5 bg-gray-800 px-5 py-4'>
                ...
                <ul className="mt-5">
                    ...
                    <li className="text-center">
                        <Link to='/dashboard/inventario' className={`${urlActual === '/dashboard/inventario' ? 'text-slate-100 bg-gray-900 px-3 py-2 rounded-md text-center' : 'text-slate-600'} text-xl block mt-2 hover:text-slate-600`}>Inventario</Link>
                    </li>

                    <li className="text-center">
                        <Link to='/dashboard/register' className={`${urlActual === '/dashboard/register' ? 'text-slate-100 bg-gray-900 px-3 py-2 rounded-md text-center' : 'text-slate-600'} text-xl block mt-2 hover:text-slate-600`}>Registrar</Link>
                    </li>
                </ul>
